...
class Level3forStudents extends StatelessWidget {
  @override
              ...
              DropdownButton(
                ...
                onChanged: (value) {
                  if(value=='Winter Semester'){
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>WinterSemesterLevel3()),
                    );
                  }
                  else if(value=='Spring Semester'){
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>SpringSemesterLevel3()),
                    );
                  }
